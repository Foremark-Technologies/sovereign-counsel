...
let NotificationsController = class NotificationsController {
    ...
    async list(req) {
        return (0, api_response_dto_1.ok)(await this.notificationsService.findForUser(req.user.organizationId, req.user.sub));
    }
};
...
exports.NotificationsController = NotificationsController = __decorate([
    (0, common_1.Controller)(['notifications', 'alerts']),
