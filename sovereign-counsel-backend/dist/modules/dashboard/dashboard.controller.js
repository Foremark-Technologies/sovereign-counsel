...
let DashboardController = class DashboardController {
    ...
    async stats(req) {
        return (0, api_response_dto_1.ok)(await this.dashboardService.getStats(req.user.organizationId));
    }
    async summary(req) {
        return (0, api_response_dto_1.ok)(await this.dashboardService.getSummary(req.user));
    }
};
